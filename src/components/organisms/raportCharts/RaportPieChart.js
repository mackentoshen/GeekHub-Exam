...
import './RaportPieChart.css';

//config
import PieChartConfig from '../../../config/PieChartConfig';

class RaportPieChart extends React.Component {
    ...
    componentWillMount() {
        ...
        fetch('/api/user/raport/pie/week', {
            ...
            .then(res => {
                ...
                let chart = this.refs.PieChartConfig.getChart();
                chart.series[0].setData(res[0].data);
                chart.setTitle({
                    text: res[0].percent + '%'
                });

                let chart2 = this.refs.PieChartConfig2.getChart();
                chart2.series[0].setData(res[1].data);
                chart2.setTitle({
                    text: res[1].percent + '%'
                });

                let chart3 = this.refs.PieChartConfig3.getChart();
    ...
    render() {
        return(
            <div className="RaportPieChart">
                <div className="pie-chart-item">
                    <ReactHighcharts config={PieChartConfig} ref='PieChartConfig'>
                    </ReactHighcharts>
                ...
                <div className="pie-chart-item">
                    <ReactHighcharts config={PieChartConfig} ref='PieChartConfig2'>
                    </ReactHighcharts>
                    <div className="pie-chart-info">
                ...
                <div className="pie-chart-item">
                    <ReactHighcharts config={PieChartConfig} ref='PieChartConfig3'>
                    </ReactHighcharts>
                    <div className="pie-chart-info">
